...
<body>
  ...
  $sql ="SELECT `id`,`date`, `last_modified`, `blog_title`, `blog_content`, `banner_img`, `categories`, `tags` FROM `post` WHERE `id` = $id";
...
======================================================= -->
    ...
    <div class="col-md-5">
         ...
         <form action="update_blog_post.php?id=<?php echo $row['id'];?>" id="myform" method="post" enctype="multipart/form-data">
        ...
        <input required type="submit" name="submit" id="update" class="form-control btn_sub_post" value="Save">
